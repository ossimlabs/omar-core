...
class ActuatorDashboardController {
  ...
  def index() {
      ...
      render view: "index2", model: [ health: health, info: info, metrics: metrics, env: env ]
  }
  ...
  def traceability() {
      ...
      render view: "trace2", model: [traceMap: traceMap]
  }
  ...
  def springBeans() {
      ...
      render view: "beans2", model: [beansMap: beansMap]
  }
  ...
  def allMappings() {
      ...
      render view: "mappings2", model: [mappingsMap: mappingsMap]
  }
